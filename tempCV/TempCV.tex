...
\begin{tabular}{rl}
    \textsc{Place and Date of Birth:} & 85, Shanti Niketan Kazi Tola, Budaun, U.P.  | 04 July 1996 \\
    \textsc{Address:}   & 402, ... Electronic City Phase-2, Bangalore \\
    \textsc{Phone:}     & +91 7503758135\\
    \textsc{email:}     & \href{mailto:kautsiitd@gmail.com}{kautsiitd@gmail.com}\\
    \textsc{github:}     & \href{https://github.com/kautsiitd}{github.com/kautsiitd}\\
    \textsc{CodeChef:}     & \href{https://www.codechef.com/users/kauts\_kanu}{codechef.com/users/kauts\_kanu}
\end{tabular}

%Section: Work Experience at the top
\section{Work Experience}
\begin{tabular}{r|p{11cm}}
 \textsc{April 2017} & iOS Developer at \textsc{Headout} s.p.a., Milan \\
 \textsc{June 2016}&\emph{Physical Natural Gas Trading}\\&\footnotesize{Provided analysis of spreads, in particular time and location spreads, with emphasis on trading opportunities on the curve, also taking into account the availability of storage facilities. Became familiar with logistic implications of physical gas trading and developed knowledge of continental virtual hubs for gas exchange.}\\\multicolumn{2}{c}{} \\
 \textsc{Summer 2015} & Summer Intern at \textsc{Zimply, New Delhi}, \emph{Backend Developer}\\&\footnotesize{Received pre-placed offer from the Exotics Trading Desk as a result of very positive review. Rated ``\emph{truly distinctive}'' for Analytical Skills and Teamwork.}
\end{tabular}
